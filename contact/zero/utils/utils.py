...
#
#
class DuplicatedConten(UserInputError):
    def __init__(self):
        cfg_helper = ConfigHelper()
        error_code_base = int(cfg_helper.get_config("CUSTOM_ERROR_CODES")["contents"])
        super(DuplicatedConten, self).__init__(message="content is already exist ",
                                               error_code=error_code_base + 102,
                                               persian_massage="مخاطبی با این مشخصات وجود دارد.")
